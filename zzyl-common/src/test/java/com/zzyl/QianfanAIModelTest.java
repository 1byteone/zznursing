...
public class QianfanAIModelTest {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream fis = new FileInputStream("D:\\ZZYL\\Course\\09. 智能评估-集成AI大模型\\资料\\体检报告样例\\体检报告-刘爱国-男-69岁.pdf");
        ...
        OpenAIClient client = OpenAIOkHttpClient.builder()
                .apiKey("bce-v3/ALTAK-4VXbijt1HIxOSAlBnKJ7j/d86f290404cfa9a236d51a749b58a4fe866bfab1") //将your_APIKey替换为真实值，如何获取API Key请查看https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Um2wxbaps#步骤二-获取api-key
